...
MeanWeight_plots = ggplot(time_series_mw, aes(x = Year, y = MeanWeight, colour = scen, fill = scen)) +
  ...
  geom_line(aes(y = sim_mean, colour = scen)) +
  ...
  scale_colour_manual(
    ...
    labels = c("Calibration", 
               "Fishing mortality without natural", 
               "Fishing with natural additional mortality")) +
  scale_fill_manual(
    name = NULL,
    values = c("grey70", "#4575B4", "#D73027"),
    labels = c("Calibration", 
...
cor_plot <- ggplot(cor_results_long, aes(x = Variable, y = value, fill = scen)) + 
  ...
  scale_fill_manual(values = c("Fishing with additional natural mortality" = "red", 
                               "Fishing without additional natural mortality" = "blue")) +
  theme(
