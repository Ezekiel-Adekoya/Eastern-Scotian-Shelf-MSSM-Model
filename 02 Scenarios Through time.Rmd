...
species<-levels(time_series$Species)<- c("AMERICAN PLAICE", "ATLANTIC COD","ATLANTIC HALIBUT", "HERRING","REDFISH UNSEPARATED", "GREENLAND HALIBUT", "HADDOCK","SAND LANCE", "SILVER HAKE", "SPINY DOGFISH",  "WHITE HAKE", "WITCH FLOUNDER", "YELLOWTAIL FLOUNDER")
...
combined_data$Legend <- factor(combined_data$Legend, 
                               levels = c("Resource","SAND LANCE", "HERRING", "HADDOCK", "YELLOWTAIL FLOUNDER", "WITCH FLOUNDER", "AMERICAN PLAICE", "REDFISH UNSEPARATED", "SILVER HAKE", "SPINY DOGFISH", "ATLANTIC COD", "WHITE HAKE", "GREENLAND HALIBUT", "ATLANTIC HALIBUT"))
